...
begin
  ...
  if checkPreview.Checked then begin
  ...
  begin
    ...
    For A := 1 to Loops do}
      ...
      begin
        ...
        ACBrIBPTax1.AbrirTabela('C:\StockSYS2\IBPT\18.1.A\TabelaIBPTaxCE18.1.A.csv');     //LEMBRAR DE ALTERAR
...
begin
  ...
  if ACBrSAT1.Extrato = ACBrSATExtratoFortes1 then
  begin
  ...
  ACBrSATExtratoESCPOS1.Impressora := lImpressora.Caption;
   end;
...
begin
  ...
  try
    ...
    if checkPreview.Checked then begin
    INI.WriteString('PosPrinter','Preview', '1');
    end else begin
    INI.WriteString('PosPrinter','Preview', '0');
    end;
...
begin
  ...
  try
    ...
    if INI.ReadString('PosPrinter', 'Preview', '') = '1' then begin
