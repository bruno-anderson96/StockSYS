...
begin
  //
  tblComprasVALOR_TOTAL.DisplayFormat     := '###,###,##0.00';
  tblComprasVALOR_TOTAL.EditFormat        := '###,###,##0.00';
  cdsCTempItensVALOR_TOTAL.DisplayFormat  := '###,###,##0.00';
  cdsCTempItensVALOR.DisplayFormat        := '###,###,##0.00';
  // Transportadora
  ...
  tblEmitenteINSCEST.EditMask            := '00000000000-0;0';
  //Fornecedor
...
begin
  ...
  //WebService
    ...
    ACBrNFe1.Configuracoes.WebServices.Ambiente     := TpcnTipoAmbiente(telaConfig.gbAmbiente.ItemIndex);
...
begin
ACBrIBGE1.BuscarPorNome(cidade,uf,false);
...
begin
  if telaDados.tblLogin.state = dsInsert then begin
    ...
    telaDados.qryLogin.RecordCount;
    telaDados.qryLogin.Open;
    telaDados.tblLoginID.Value := telaDados.qryLogin.RecordCount + 1;
  end;
end;
