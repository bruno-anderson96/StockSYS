object telaDados: TtelaDados
  ...
  object tblPedidos: TIBTable
    ...
    object tblPedidosVAL_PIS: TIBBCDField
      FieldName = 'VAL_PIS'
      Precision = 9
      Size = 2
    end
    object tblPedidosVAL_COFINS: TIBBCDField
      FieldName = 'VAL_COFINS'
      Precision = 9
      Size = 2
    end
    object tblPedidosVAL_ICMS: TIBBCDField
      FieldName = 'VAL_ICMS'
      Precision = 9
      Size = 2
    end
    object tblPedidosVAL_ICMSSUB: TIBBCDField
      FieldName = 'VAL_ICMSSUB'
      Precision = 9
      Size = 2
    end
    object tblPedidosVAL_IPI: TIBBCDField
      FieldName = 'VAL_IPI'
      Precision = 9
      Size = 2
    end
    object tblPedidosBC_PIS: TIBBCDField
      FieldName = 'BC_PIS'
      Precision = 9
      Size = 2
    end
    object tblPedidosBC_COFINS: TIBBCDField
      FieldName = 'BC_COFINS'
      Precision = 9
      Size = 2
    end
    object tblPedidosBC_ICMS: TIBBCDField
      FieldName = 'BC_ICMS'
      Precision = 9
      Size = 2
    end
    object tblPedidosBC_ICMSSUB: TIBBCDField
      FieldName = 'BC_ICMSSUB'
      Precision = 9
      Size = 2
    end
    object tblPedidosBC_IPI: TIBBCDField
      FieldName = 'BC_IPI'
      Precision = 9
      Size = 2
    end
    object tblPedidosALIQUOTA_PIS: TIBBCDField
      FieldName = 'ALIQUOTA_PIS'
      Precision = 9
      Size = 2
    end
    object tblPedidosALIQUOTA_COFINS: TIBBCDField
      FieldName = 'ALIQUOTA_COFINS'
      Precision = 9
      Size = 2
    end
    object tblPedidosALIQUOTA_ICMS: TIBBCDField
      FieldName = 'ALIQUOTA_ICMS'
      Precision = 9
      Size = 2
    end
    object tblPedidosALIQUOTA_ICMSSUB: TIBBCDField
      FieldName = 'ALIQUOTA_ICMSSUB'
      Precision = 9
      Size = 2
    end
    object tblPedidosALIQUOTA_IPI: TIBBCDField
      FieldName = 'ALIQUOTA_IPI'
      Precision = 9
      Size = 2
    end
  ...
  object cdsTempItens: TClientDataSet
    ...
    Top = 264
    Data = {
      CE0100009619E0BD010000001800000019000000000003000000CE0102494404
      ...
      
      415F434F46494E5308000400000000000000}
    ...
    object cdsTempItensBC_ICMS: TFloatField
      FieldName = 'BC_ICMS'
    end
    object cdsTempItensBC_ICMSSUB: TFloatField
      FieldName = 'BC_ICMSSUB'
    end
    object cdsTempItensBC_PIS: TFloatField
      FieldName = 'BC_PIS'
    end
    object cdsTempItensBC_COFINS: TFloatField
      FieldName = 'BC_COFINS'
    end
    object cdsTempItensBC_IPI: TFloatField
      FieldName = 'BC_IPI'
    end
    object cdsTempItensVAL_ICMS: TFloatField
      FieldName = 'VAL_ICMS'
    end
    object cdsTempItensVAL_ICMSSUB: TFloatField
      FieldName = 'VAL_ICMSSUB'
    end
    object cdsTempItensVAL_PIS: TFloatField
      FieldName = 'VAL_PIS'
    end
    object cdsTempItensVAL_COFINS: TFloatField
      FieldName = 'VAL_COFINS'
    end
    object cdsTempItensVAL_IPI: TFloatField
      FieldName = 'VAL_IPI'
    end
    object cdsTempItensALIQUOTA_ICMS: TFloatField
      FieldName = 'ALIQUOTA_ICMS'
    end
    object cdsTempItensALIQUOTA_ICMSSUB: TFloatField
      FieldName = 'ALIQUOTA_ICMSSUB'
    end
    object cdsTempItensALIQUOTA_PIS: TFloatField
      FieldName = 'ALIQUOTA_PIS'
    end
    object cdsTempItensALIQUOTA_IPI: TFloatField
      FieldName = 'ALIQUOTA_IPI'
    end
    object cdsTempItensALIQUOTA_COFINS: TFloatField
      FieldName = 'ALIQUOTA_COFINS'
    end
  end
  ...
  object tblCompras: TIBTable
    ...
    object tblCompraspVeiculo: TStringField
      FieldKind = fkLookup
      FieldName = 'pVeiculo'
      LookupDataSet = tblVeiculo
      LookupKeyFields = 'ID'
  ...
  object tblCompraItens: TIBTable
    ...
    object tblCompraItensCFOP: TIBStringField
      FieldName = 'CFOP'
      Size = 5
    end
  end
  ...
  object tblLogin: TIBTable
    ...
    Left = 784
    Top = 80
    object tblLoginID: TIntegerField
      FieldName = 'ID'
      Required = True
    end
    object tblLoginLOGIN: TIBStringField
      FieldName = 'LOGIN'
      Required = True
      Size = 18
    end
    object tblLoginSENHA: TIBStringField
      FieldName = 'SENHA'
      Required = True
    end
    object tblLoginADM: TIntegerField
      FieldName = 'ADM'
    end
  end
  ...
  object trnscLogin: TIBTransaction
    Active = True
    DefaultDatabase = dbLogin
    AutoStopAction = saNone
    Left = 736
    Top = 80
  end
  object ibdsLogin: TIBDataSet
    ...
    SelectSQL.Strings = (
      'select * from LOGIN')
    GeneratorField.Field = 'ID'
    GeneratorField.Generator = 'GEN_LOGIN_ID'
    DataSource = dsLogin
    Left = 832
    Top = 120
  end
  ...
  object dbCidades: TIBDatabase
    ...
    Params.Strings = (
      ...
      'password=masterkey')
    LoginPrompt = False
    DefaultTransaction = trnscCidades
    IdleTimer = 0
    SQLDialect = 3
    TraceFlags = []
    Left = 1000
  ...
  object tblContador: TIBTable
    ...
    Left = 104
    Top = 584
    object tblContadorID: TIntegerField
      FieldName = 'ID'
    end
    object tblContadorNOME: TIBStringField
      FieldName = 'NOME'
      Size = 60
    end
    object tblContadorENDERECO: TIBStringField
      FieldName = 'ENDERECO'
      Size = 60
    end
    object tblContadorNUM: TIBStringField
      FieldName = 'NUM'
      Size = 10
    end
    object tblContadorCOMPL: TIBStringField
      FieldName = 'COMPL'
      Size = 100
    end
    object tblContadorBAIRRO: TIBStringField
      FieldName = 'BAIRRO'
      Size = 60
    end
    object tblContadorEMAIL: TIBStringField
      FieldName = 'EMAIL'
      Size = 30
    end
    object tblContadorCNPJ: TIBStringField
      FieldName = 'CNPJ'
    end
    object tblContadorCEP: TIBStringField
      FieldName = 'CEP'
      Size = 10
    end
    object tblContadorCOD_MUN: TIBStringField
      FieldName = 'COD_MUN'
      Size = 7
    end
    object tblContadorCPF: TIBStringField
      FieldName = 'CPF'
      Size = 10
    end
    object tblContadorCELULAR: TIBStringField
      FieldName = 'CELULAR'
      Size = 12
    end
  ...
  object trnscContador: TIBTransaction
    Active = True
    DefaultDatabase = dbContador
    AutoStopAction = saNone
    Left = 64
    Top = 584
  end
  object dbContador: TIBDatabase
    ...
    Params.Strings = (
      ...
      'password=masterkey')
    LoginPrompt = False
    DefaultTransaction = trnscContador
    IdleTimer = 0
    SQLDialect = 3
    TraceFlags = []
    Left = 144
  ...
  object ibdsContador: TIBDataSet
    Database = dbContador
    Transaction = trnscContador
    BufferChunks = 1000
    CachedUpdates = False
    SelectSQL.Strings = (
      'select * from CONTADOR')
    GeneratorField.Field = 'ID'
    GeneratorField.Generator = 'GEN_CONTADOR_ID'
    DataSource = dsContador
    Left = 144
    Top = 624
  end
  ...
  object tblPos: TIBTable
    ...
    object tblPosCHREQ: TIBStringField
      FieldName = 'CHREQ'
      Size = 40
    end
  end
  ...
  object cdsCTempItens: TClientDataSet
    ...
    PacketRecords = 0
    Params = <>
    AfterPost = cdsCTempItensAfterPost
    Left = 576
    Top = 264
    Data = {
    ...
    object cdsCTempItensVALOR_TOTAL: TFloatField
      FieldName = 'VALOR_TOTAL'
    end
    object cdsCTempItensQUANTIDADE: TIntegerField
      FieldName = 'QUANTIDADE'
    end
